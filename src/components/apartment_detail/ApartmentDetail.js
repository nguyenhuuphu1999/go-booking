...
const ApartmentDetail = ({ apartment_name, ratings, price, url_image }) => {
  const container = {
    display: 'grid',
  ...
  return (
    <div
      ...
      <div style={txtStyle}>
        ...
        <div style={{ color: 'red' }}>Giá chỉ từ: {price}$/đêm</div>
      </div>
    </div>
  )
}
