  ...
  return (
    <div className="App">
      ...
      <div className="near-by-locations">
        {
          NearbyLocationListItems.map(location => <NearbyLocationListItem location = {location}/>)
        }
      </div>
      
      <div className="room-item-list">
        {
          RoomListItems.map(room => <RoomListItem roomItem = {room}/>)
        }
      </div>
...
let feedbacks = [
  ...
  place: 'VeeVoo Hotel',
  city: 'Vũng Tàu',
  content: 'Nhà mình đi cùng em bé nên có ghi rõ trong phần yêu cầu đặc biệt trên GO lúc đặt phòng. Nhân viên khách sạn rất tận tình và chu đáo. Cả nhà mình đã có một kỳ nghỉ thật tuyệt, rất đáng giới thiệu cho mọi người!',
  by: 'Chị Thu, Hà Nội'
  },
  {
  place: 'Serena Nha Trang Hotel ',
  city: 'Nha Trang',
  content: 'Tôi hoàn toàn hài lòng khi nghỉ tại Nha Trang. Cám ơn GO rất nhiều.',
...
let RoomListItems = [
  {
    ...
    photos:"https://a0.muscache.com/im/pictures/382fece9-d731-4c0c-ab2d-f45810526ac0.jpg?im_w=1200"
  },
  {
    id: 2,
    ...
    photos: "https://a0.muscache.com/im/pictures/miso/Hosting-39655954/original/12817cae-5fd8-4820-8711-291f6b297c3c.jpeg?im_w=1200"
  }
];
