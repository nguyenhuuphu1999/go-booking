...
const HomeStayPage = () => {
  ...
  const nearbyLocationItemList = useSelector(state => state.homeStay.RattingGood)
  ...
  return (
    <div>
      ...
      <div style={{margin: '90px auto 0 auto', maxWidth: '1350px'}}>
        <h3 style={h3Style} typeHouse={typeHouse}>{typeHouse.title}</h3>
        <HomeStayNearYou homeStayList={homeStayList} />
        <FamousPlaces/>
        <h3 style={h3Style} typeHouse={typeHouse}>Khách đánh giá cao vị trí của những {typeHouse.title} này</h3>
